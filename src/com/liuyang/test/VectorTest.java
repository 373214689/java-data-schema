...
import com.liuyang.data.MatrixSet;
...
public class VectorTest {
	...
	public static void main(String[] args) {
		...
		MatrixSet ms = new MatrixSet(schema);
		
		System.out.println(ms.schema());
		
		ms.readTextFile(line -> Row.parseLine(schema, line, "|"), true
				,"d:/test/LTE_GZ_YDGZG00499_103000036816_20180220000000.txt"
		);
		/*ms.readTextFile(line -> ms.createRow().parseLine(line, "|"), false
				,"d:/test/LTE_GZ_YDGZG00499_103000036816_20180220000000.txt"
		);*/

		System.out.println("read used: " + String.format("%.2fms", (System.nanoTime() - s) / 1000000));
		System.out.println("MatrixSet size: " + ms.size());
		//System.out.println(ms);

		s = System.nanoTime();
		
		MatrixSet ms02 = ms.select("imsi", "uri");

		System.out.println("select used: " + String.format("%.2fms", (System.nanoTime() - s) / 1000000));
		System.out.println("MatrixSet size: " + ms02.size());
		System.out.println(ms02);

		MatrixSet ms03 = ms02.distinct();
		System.out.println("distinct used: " + String.format("%.2fms", (System.nanoTime() - s) / 1000000));
		System.out.println("MatrixSet size: " + ms03.size());
		System.out.println(ms03);
